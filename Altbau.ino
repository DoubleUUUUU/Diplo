...
{
  sensor.clearFields();
  sensor.addField("humidity_Altbau", sen_hum);
  sensor.addField("temperature_Altbau", sen_tmp);
  sensor.addField("CO2_Altbau", sen_CO2);
...
void setup() {
  sensor.addTag("environment", "altbau_sensor1");
  Serial.begin(115200);
